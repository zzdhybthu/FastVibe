...
export const en: Translations = {
  ...
  config: {
    ...
    defaultThinking: 'Default Thinking Mode',
    defaultThinkingDesc: 'Enable thinking mode by default when creating tasks',
    defaultContinueSession: 'Default Continue Session',
    defaultContinueSessionDesc: 'Enable continue session by default when creating tasks',
    defaultModel: 'Default Model',
    defaultModelDefault: 'default',
    logLevel: 'Log Level',
  ...
  taskForm: {
    ...
    continueSessionDesc: 'Continue execution based on the predecessor task session',
    continueSessionAgentMismatch: 'Predecessor uses a different agent; session continuation will fall back to normal mode',
