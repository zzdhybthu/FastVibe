...
const STATUS_CONFIG: Record<TaskStatus, { label: string; color: string; bg: string }> = {
  PENDING: { label: '等待中', color: 'text-slate-400', bg: 'bg-slate-400/10 border-slate-400/20' },
  ...
  CANCELLED: { label: '已取消', color: 'text-slate-500', bg: 'bg-slate-500/10 border-slate-500/20' },
};
